...
#ifdef FT_INT
	PORTCFG.MPCMASK=FT800_IRQ;					  //Maskujemy pin, którego konfiguracjê zmieniamy
	FT800_CTRL_PORT.PIN0CTRL=PORT_ISC_FALLING_gc; //Zbocze opadaj¹ce wywo³a przerwanie
	FT800_CTRL_PORT.INT0MASK|=FT800_IRQ;          //Pin do którego jest pod³¹czony sygna³ INT
	FT800_CTRL_PORT.INTCTRL|=PORT_INT0LVL_LO_gc;  //Odblokuj przerwania INT0 portu
#endif
}
