...
typedef union
{
	struct
	{
		uint8_t IB00       : 8;    //Bity o wartoœci 0
		uint8_t SS         : 1;		//Kolejnoœæ wyjœæ 0-720 lub 720-0
		uint8_t IB01       : 1;
		uint8_t SM	       : 1;		//Sposób sterowania driverami
		uint8_t IB02       : 5;		//5 bitów o wartoœci 0
	};
	uint16_t word;
...
typedef union
{
	struct
	{
		...
		uint8_t IB02       : 6;		//6 bitów o wartoœci 0
	};
	uint16_t word;
...
typedef union
{
	struct
	{
		...
		_Bool DTE	       : 1;		// 
		_Bool GON	       : 1;		//DTE=GON=1 - normalne wyœwietlanie
		uint8_t IB01       : 2;		//
		_Bool BASEE		   : 1;		// 1 - wyœwietlaj obraz podstawowy
		uint8_t IB02       : 3;		//
		_Bool PTDE0		   : 1;		// 1 - w³¹cz wyœwietlanie czêœciowego obrazu
		_Bool PTDE1		   : 1;		// 1 - w³¹cz wyœwietlanie czêœciowego obrazu
		uint8_t IB03       : 2;		//
	};
	uint16_t word;
...
typedef union
{
	struct
	{
		_Bool REV	       : 1;		// Odwrócenie skali szaroœci (inwersja obrazu)
		_Bool VLE	       : 1;		// Rozpoczêcie wyœwietlania obrazu pocz¹wszy od linii wskazywanej przez rejestr ILI9328_BASEIMAGESCROLL
		_Bool NDL	       : 1;		//Stan drivera w niewyœwietlanych fragmentach obrazu
		uint16_t IB01      : 13;	//
	};
	uint16_t word;
...
#define ILI9328_GAMMAFINEADJREG_PP0							0x30         // Gamma Control 1
#define ILI9328_GAMMAFINEADJREG_PP1							0x31         // Gamma Control 2
#define ILI9328_GAMMAFINEADJREG_PP2							0x32         // Gamma Control 3
#define ILI9328_GAMMAGRADIENTADJREG_PP						0x35         // Gamma Control 4
#define ILI9328_GAMMAAMPLITUDEADJREG_PP						0x36         // Gamma Control 5
#define ILI9328_GAMMAFINEADJREG_NP0							0x37         // Gamma Control 6
#define ILI9328_GAMMAFINEADJREG_NP1							0x38         // Gamma Control 7
#define ILI9328_GAMMAFINEADJREG_NP2							0x39         // Gamma Control 8
#define ILI9328_GAMMAGRADIENTADJREG_NP						0x3c         // Gamma Control 9
#define ILI9328_GAMMAAMPLITUDEADJREG_NP						0x3d         // Gamma Control 10
