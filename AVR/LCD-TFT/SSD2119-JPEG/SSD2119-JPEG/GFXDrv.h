...
void LCD_CpyBitmap_RGB(uint16_t x, uint8_t y, uint16_t width, uint8_t height, const uint8_t *data); //Skopiuj dane w formacie R8G8B8 z pamiêci na wskazan¹ pozycjê LCD
