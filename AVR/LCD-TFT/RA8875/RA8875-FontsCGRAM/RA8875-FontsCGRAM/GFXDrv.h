...
void LCD_DrawBitmap_Mono(uint16_t x, uint16_t y, uint16_t color, uint16_t bkgcolor,
                         const uint8_t __flash *data, _Bool transparency);         //Wyœwietl monochromatyczn¹bitmapê na pozycji (x,y) z podanymi kolorami i opcjonaln¹ przezroczystoœci¹, tylko g³êbia 16-bitowa
