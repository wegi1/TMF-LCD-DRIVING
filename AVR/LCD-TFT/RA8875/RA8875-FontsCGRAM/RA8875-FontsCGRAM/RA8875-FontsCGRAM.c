...
void RA_SetCGRAMChar(uint8_t charno, const uint8_t __memx desc[16])
{
...
const uint8_t __memx znak1[16]={0, 255, 0, 255, 0, 255, 0, 255, 0, 255, 0, 255, 0, 255, 0, 255};  //Naprzemienne linie
const uint8_t __memx znak2[16]={0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55};  //Szachownica
