...
const uint8_t *data, _Bool transparency);         //Wyœwietl monochromatyczn¹bitmapê na pozycji (x,y) z podanymi kolorami i opcjonaln¹ przezroczystoœci¹, tylko g³êbia 16-bitowa
