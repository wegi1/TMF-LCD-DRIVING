...
typedef enum {RA_OneLayer=0x00, RA_TwoLayers=0x80, RA_HDIR=0x08, RA_VDIR=0x04} RA_DPCR;
...
typedef union
{
	struct
	{
		_Bool ReadAutoIncr     : 1;			//0 - kursor automatycznie siê zwiêksza, 1 - kursor sta³y przy odczycie
		_Bool WriteAutoIncr    : 1;			//0 - kursor automatycznie siê zwiêksza, 1 - kursor sta³y przy zapisie
