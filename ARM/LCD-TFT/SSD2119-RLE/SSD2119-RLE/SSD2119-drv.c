...
void LCD_DrawBitmapRLE_565(uint16_t x, uint8_t y, const uint16_t *data)
{
	if(LCD_Driver_Status.Mode565 == false) SED2119_RGB565();     //Prze³¹cz siê na tryb przesy³ania 2 bajty na piksel
...
void LCD_DrawBitmapRLE_Mono(uint16_t x, uint8_t y, uint16_t color, uint16_t bkgcolor, const uint8_t *data)
{
